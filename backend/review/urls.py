...
urlpatterns = [
    ...
    path("is_eligible/", IsEligibleForWritingReviewAPIView.as_view()),
    ...
    path("comments/<int:pk>/", UserReviewCommentRetrieveUpdateDestroyAPIView.as_view(),
         name='update, destroy user review comment'),
